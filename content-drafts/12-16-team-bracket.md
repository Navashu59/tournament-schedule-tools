...
The bracket needs byes to fill the next clean bracket size. Review who receives those byes before publishing.

**Should I use manual seeding or shuffle?**
Use manual seeding when ranking matters. Use shuffle for casual draws.

**What should I check first?**
Check seed order, first-round matchups, byes, and whether the path to the final is easy to follow.
