...
- **5 teams, single elimination:** 3 byes are needed to fill an 8-slot bracket.
- **6 teams, single elimination:** 2 byes are needed.
- **7 teams, single elimination:** 1 bye is needed.
...
**How many byes are in a 6-team bracket?**
Two byes, because a 6-team field needs to fit into an 8-slot bracket.

**Do byes count as games played?**
Usually no. In a bracket they advance the participant; in a round robin they are a rest round. Standings rules can vary, so check the event rule set before treating a bye as a win.
