...
**Does double elimination always need a bracket reset?**
No. Many traditional double elimination events use a reset or "if game," but some organizers choose one final for time. State the rule before play starts.

**Is single elimination unfair?**
It can feel harsh because one bad match ends the run, but it is not automatically unfair. Seeding, byes, rest, and clear rules matter as much as the format choice.
