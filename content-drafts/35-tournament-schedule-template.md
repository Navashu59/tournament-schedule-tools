...
## What this tournament schedule template page covers
...
A tournament schedule template is only useful if the organizer can trust it under real event constraints. Use this checklist before you share the schedule:
