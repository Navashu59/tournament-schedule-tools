...
| P2 | Implemented 2026-06-03 | `/guides/how-double-elimination-works/` | Explain winners bracket, losers bracket, reset/if game, and game count | `how double elimination works` 20; `how many games in double elimination tournament` 20 | `/double-elimination-bracket-generator/`, `/single-elimination-vs-double-elimination/` | Built with reset-game caveats, match-count estimate, and clear limits around modified final rules. |
| P2 | Implemented 2026-06-03 | `/guides/round-robin-tiebreakers/` | Explain common tie-breaker approaches for round robin standings | Semrush exact weak/0, but SERP/forum pain is real around multi-team ties | `/round-robin-generator/`, `/round-robin-schedule-maker/`, `/guides/how-many-games-in-a-round-robin/` | Built as a practical organizer template with official-rule caveats, three-way tie handling, and messy-result notes. |
| P2 | Implemented 2026-06-03 | `/guides/third-place-playoff/` | Explain third-place games, bronze medal games, and when to add one | `third place playoff` 40 | `/single-elimination-bracket-generator/`, `/tournament-bracket-maker/`, `/guides/consolation-bracket/` | Built as a narrow bronze-match guide with consolation distinction, scheduling choices, and optional/required notes. |
